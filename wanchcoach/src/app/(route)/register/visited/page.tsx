...
import { MedicalKeywordResultData, PharmacyResultData } from "@/app/util/controller/medicalContoller";
...
export default function Visited() {
  ...
  const [chooseVisitor, setChooseVisitor] = useState<FamilySummaryListData>({familyId:0, name:'', color:''});
  const [choosePharmacy, setChoosePharmacy] = useState<PharmacyResultData>({ pharmacyId: 0, name: '', address: '' });
  ...
  return (
    <div className={styles.container}>
      ...
      <SelectInputbox label="방문자" value={chooseVisitor} handleVisitorChange={handleVisitorChange}/>
      <DateInputBox label="날짜" selectedDate={date} handleDateChange={handleDateChange} />
      <TimeInputBox label="시간" selectedTime={time} handleTimeChange={handleTimeChange} />
      <TextAreaInputbox
        label="증상"
        value={symptoms}
  ...
  return (
    <div className={styles.prescription_container}>
      ...
      <div className={styles.drug_container}>
        <div className="pt-1" />
        <ModalInputBox2 label="약국명" placeholder="약국 명" value={choosePharmacy} handlePharmacyChange={handlePharmacyChange}/>
        <div className="mt-4">
